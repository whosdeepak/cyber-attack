...
import { Shield, Eye, EyeOff, AlertCircle, Lock, Mail, User } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-2">Join CyberWatch Pro</h2>
          <p className="text-gray-300">Create your Security Operations account</p>
          <p className="text-sm text-gray-400 mt-2">Get access to real-time cybersecurity monitoring</p>
        </div>
        ...
        <div className="bg-gray-800/50 p-4 rounded-xl border border-gray-700">
          ...
          <p className="text-gray-400 text-xs">
            Your account will be created with viewer permissions. Contact your administrator 
            for elevated access to advanced security features.
          </p>
        </div>
      </div>
    </div>
